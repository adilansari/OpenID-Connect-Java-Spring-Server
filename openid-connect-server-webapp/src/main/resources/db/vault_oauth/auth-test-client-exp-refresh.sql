SET @clientDescription = 'Expired Refresh Token (valid 1 second, access valid 1 second)';
SET @clientId = 'U3GgtFXcxGk5P5K3wfAA';
SET @clientSecret = 'ljlHsRshQ6K811MsPON9KmsNsK6OiVWLP3drkoMP';
...
SELECT
  @clientDescription, @clientId, @clientSecret, 'HS256', 1, 1 FROM DUAL
WHERE NOT EXISTS
